...
filename = ["/home/john/Downloads/CLASS-PT/output/mless_LCDM_PT_km100_pk_pto.dat", "/home/john/Downloads/CLASS-PT/output/mless_LCDM_PT_km100_pk_nl_pt.dat"]
names = []
dat = []
...
for i in range(0, len(dat[0])):     
    ...
    ctr_arr[i] = dat[1][i][2]
tot_arr = pk_arr + tree_arr + (2*cs/h**2)*ctr_arr
...
plt.legend()
plt.savefig("plots/check_lin_nonlin.png")
plt.show()
